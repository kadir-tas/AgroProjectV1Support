...
//TODO: popuprecyclerview kaldırıldı.Kadir.
    Dialog dialogFarmName, dialogSensorInfo;
    ArrayList<String> farmNames;
    DatabaseReference ref;

    String user_id;
//TODO: edituser dan gönderilen farm ismini almak için eklendi. Kadir.
    String farmName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_farm.on_long_click_listener = new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Log.v("ASD", "HEREE");
                if (edit_farm.getCurrent_phase() == FarmEditView.EditPhases.MODULE_PLACEMENT_PHASE
                        && edit_farm.isAllow_putting_data()) {
                    spawn_module_selection_fragment();
                }else if(edit_farm.getCurrent_phase() == FarmEditView.EditPhases.MODULE_PLACEMENT_PHASE && edit_farm.isCan_remove_data()){
        ...
        save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                edit_farm.save_farm();
                if(edit_farm.getCurrent_phase() != FarmEditView.EditPhases.OUTLINE_DRAW_PHASE){
